...
public final class ApiCallback<T> implements Callback {
    ...
    public ApiCallback(int requestId, AtomicInteger currentId, Parser<T> parser, Consumer<T> success, Consumer<Exception> error) {
